/*
exec sp_SelectWaiverFinancialSummary
*/


if OBJECT_ID('sp_SelectWaiverFinancialSummary') is not null
	drop procedure sp_SelectWaiverFinancialSummary
	
go
create procedure sp_SelectWaiverFinancialSummary
